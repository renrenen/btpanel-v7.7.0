...
if [ -d "/www/server/phpmyadmin/pma" ];then
	...
	if [ "${EN_CHECK}" ];then
		curl https://raw.githubusercontent.com/779776787/btpanel-v7.7.0/main/install/update6_en.sh|bash
	else
		curl https://raw.githubusercontent.com/779776787/btpanel-v7.7.0/main/install/update6.sh|bash
	fi
